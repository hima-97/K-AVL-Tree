...
- The fraction part contains exactly one digit
...
- A function to insert a value into the K-AVL tree
- A function to delete a value from the K-AVL tree
- A function to search a value in the K-AVL tree
- A function to find the value in the K-AVL tree that is closest to a value you specify
...
Upon passing the string command `"insert [whole part] [decimal part]"` via argv[1], the program should print out:
...
- `9.3 inserted`, if there was no "9.3" in the K-AVL tree upon inserting
- Print nothing if "9.3" is already in the K-AVL tree upon inserting

# Search Function

Function for searching a decimal value in the K-AVL tree.

Upon passing the string command `"search [whole part] [decimal part]"` via argv[1], the program should print out:
- `[whole part].[decimal part] inserted`
...
- `if ($?) { g++ k_AVL.cpp main.cpp -o k_AVL } ; if ($?) { .\k_AVL "2, insert 2 2, insert 5 2, search 2 2, approx_search 5 1, in_order, pre_order, delete 2 2" }`
